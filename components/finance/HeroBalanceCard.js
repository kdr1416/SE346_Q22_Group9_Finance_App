...
const styles = StyleSheet.create({
  ...
  label: { fontSize: Typography.labelMd, color: Colors.onPrimary, opacity: 0.7, marginBottom: Spacing.xs },
  balance: {
  ...
  divider: { height: 1, backgroundColor: Colors.onPrimary, opacity: 0.15, marginBottom: Spacing.lg },
  ...
  statLabel: { fontSize: Typography.labelSm, color: Colors.onPrimary, opacity: 0.7 },
  statValue: { fontSize: Typography.titleSm, fontWeight: Typography.medium, color: Colors.onPrimary },
});
